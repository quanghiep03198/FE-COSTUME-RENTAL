...
export const createWarehouseSchema = z.object({
  ...
  managed_by: z.object({ id: z.number(), full_name: z.string() }, { message: 'Vui lòng chọn nhân viên quản lý kho' }),
  type: z.object({ label: z.string(), value: z.nativeEnum(ItemType) }, { message: 'Vui lòng chọn loại kho' }),
})

...
function SidebarProvider({
  ...
  style,
  children,
  cookiePersistStateKey = SIDEBAR_COOKIE_NAME,
  ...props
}: React.ComponentProps<'div'> & {
  cookiePersistStateKey?: string
  defaultOpen?: boolean
  open?: boolean
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      document.cookie = `${cookiePersistStateKey}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
    },
    [setOpenProp, open]
  )

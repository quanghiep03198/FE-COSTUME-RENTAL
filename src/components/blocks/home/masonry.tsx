  ...
  return (
    <section
      ...
      className={cn(
        ...
        '[&_*[data-slot=card]]:hidden [&_*[data-slot=card]]:aria-current:flex [&_*[data-slot=card]]:transition-discrete [&_*[data-slot=card]]:aria-current:animate-in [&_*[data-slot=card]]:duration-700 [&_*[data-slot=card]]:paused [&_*[data-slot=card]]:aria-current:running [&_*[data-slot=card]]:fade-in-0 [&_*[data-slot=card]]:blur-in-lg [&_*[data-slot=card]]:slide-in-from-bottom-10 [&_*[data-slot=card]]:ease-out'
      )}
    >
      <Card aria-current={inView} className=" col-start-1 xl:row-span-full p-0 relative lg:min-h-160 min-h-100">
        ...
        <CardContent className="flex flex-col items-start gap-y-1.5 relative z-10 mt-auto py-6 bg-linear-to-t from-[#00ad9695] to-75% to-transparent rounded-none">
          ...
          <Link to="/products" className={buttonVariants({ variant: 'secondary', effect: 'glass' })}>
      ...
      <Card
        aria-current={inView}
        className=" xl:col-start-3 sm:max-lg:col-span-full relative row-span-1 p-0 bg-primary/10 text-primary gap-0"
      >
      ...
      <Card
        aria-current={inView}
        className=" xl:col-start-3 sm:max-lg:col-span-full  md:max-lg:row-start-3 xl:row-start-2 row-span-1 p-0 relative"
      >

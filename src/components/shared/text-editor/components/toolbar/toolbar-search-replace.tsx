...
export function SearchAndReplaceToolbar() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={false}>
      ...
      />
      <PopoverContent align="start" sideOffset={12} className="relative flex w-100 px-3 py-2.5">
        {!replacing ? (
          ...
          <div className={cn('relative w-full')}>
            ...
            <div className="my-2 w-full">
              <div className="mb-3">
                <Label className="text-gray-11 mb-1 text-xs">Tìm kiếm</Label>
                <Input
                  value={searchText}
                  onChange={(e) => {
                    setSearchText(e.target.value)
              ...
              <div className="mb-2">
                <Label className="text-gray-11 mb-1 text-xs">Thay thế bằng</Label>
                <Input
                  className="w-full"
                  value={replaceText}
                  onChange={(e) => {
